...
graph TD
    subgraph "Staging Environment (stage)"
        ...
        %% Connections
        Internet([Internet]) --> ClientVPN(Client VPN)
        Internet --> CloudFront(CloudFront + WAF)
    ...
    class VPC,ALB,ASG,RDS,ElastiCache,S3,KMS,SecretsManager,SNS,CloudTrail,CloudFront,ClientVPN core;
